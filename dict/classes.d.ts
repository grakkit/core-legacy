...
class AbstractArrow$PickupStatus extends Enum<AbstractArrow$PickupStatus> {
...
interface AbstractHorse extends Vehicle, InventoryHolder, Tameable {
...
interface AbstractHorseInventory extends Inventory {
...
interface AbstractVillager extends Breedable, NPC, InventoryHolder, Merchant {
...
interface Advancement extends Keyed {
...
interface Ageable extends BlockData {
...
interface AnaloguePowerable extends BlockData {
...
interface Animals extends Breedable {
...
class AnvilDamagedEvent extends InventoryEvent implements Cancellable {
...
class AnvilDamagedEvent$DamageState extends Enum<AnvilDamagedEvent$DamageState> {
...
interface AnvilInventory extends Inventory {
...
interface ArmoredHorseInventory extends AbstractHorseInventory {
   /**Gets the item in the horse's armor slot.*/
   getArmor(): ItemStack;
   /**Sets the item in the horse's armor slot.*/
   setArmor(stack: ItemStack): void;
}
interface ArmorStand extends LivingEntity {
...
class ArmorStand$LockType extends Enum<ArmorStand$LockType> {
...
interface ArmorStandMeta extends ItemMeta {
...
class Art extends Enum<Art> implements Keyed {
   static ALBAN: Art;
   static AZTEC: Art;
   static AZTEC2: Art;
   static BOMB: Art;
...
class ASMEventExecutorGenerator extends Object {
...
class AsyncPlayerChatEvent extends PlayerEvent implements Cancellable {
...
class AsyncPlayerPreLoginEvent extends Event {
...
class AsyncPlayerPreLoginEvent$Result extends Enum<AsyncPlayerPreLoginEvent$Result> {
...
class AsyncTabCompleteEvent extends Event implements Cancellable {
...
interface Attachable extends BlockData {
...
interface Attachable extends Directional {
...
class Attribute extends Enum<Attribute> implements Keyed {
...
class AttributeModifier extends Object implements ConfigurationSerializable {
...
class AttributeModifier$Operation extends Enum<AttributeModifier$Operation> {
...
class AuthorNagException extends RuntimeException {
   getMessage (): String;
}
...
interface Bamboo extends Ageable, Sapling {
...
/**Bamboo leaf size.*/
class Bamboo$Leaves extends Enum<Bamboo$Leaves> {
...
interface BannerMeta extends ItemMeta {
   /**Adds a new pattern on top of the existing  patterns*/
   addPattern(pattern: Pattern): void;
   /**Returns the pattern at the specified index*/
   getPattern(i: number): Pattern;
...
class BarColor extends Enum<BarColor> {
...
class BarFlag extends Enum<BarFlag> {
   static CREATE_FOG: BarFlag;
   static DARKEN_SKY: BarFlag;
   static PLAY_BOSS_MUSIC: BarFlag;
}
/**Represents a captured state of a Barrel.*/
interface Barrel extends Container, Lootable, Lidded {}
class BarStyle extends Enum<BarStyle> {
...
class BatToggleSleepEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface Beacon extends TileState, Lockable, Nameable {
...
class BeaconEffectEvent extends BlockEvent implements Cancellable {
...
interface BeaconInventory extends Inventory {
...
interface Bed extends Directional {
...
class Bed$Part extends Enum<Bed$Part> {
   static FOOT: Bed$Part;
   static HEAD: Bed$Part;
}
/**Represents a Bee.*/
interface Bee extends Animals {
...
interface Beehive extends EntityBlockStorage<Bee> {
...
interface Beehive extends Directional {
...
interface Bell extends TileState {}
/**'attachment' denotes how the bell is attached to its block.*/
interface Bell extends Directional, Powerable {
...
class Bell$Attachment extends Enum<Bell$Attachment> {
...
class Biome extends Enum<Biome> implements Keyed {
...
interface Bisected extends BlockData {
...
class Bisected$Half extends Enum<Bisected$Half> {
   static BOTTOM: Bisected$Half;
   static TOP: Bisected$Half;
}
/**Represents a captured state of a blast furnace.*/
interface BlastFurnace extends Furnace {}
/**Represents a campfire recipe.*/
class BlastingRecipe extends CookingRecipe<BlastingRecipe> {}
/**Represents a Blaze monster*/
interface Blaze extends Monster {}
...
class BlockBreakEvent extends BlockExpEvent implements Cancellable {
...
class BlockCanBuildEvent extends BlockEvent {
...
interface BlockCommandSender extends CommandSender {
   /**Returns the block this command sender belongs to*/
   getBlock(): Block;
}
/**Called when an ItemStack is successfully cooked in a block.*/
class BlockCookEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class BlockDamageEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface BlockData extends Cloneable {
...
interface BlockDataMeta extends ItemMeta {
...
class BlockDestroyEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class BlockDispenseArmorEvent extends BlockDispenseEvent {
...
class BlockDropItemEvent extends BlockEvent implements Cancellable {
...
class BlockExpEvent extends BlockEvent {
...
class BlockFace extends Enum<BlockFace> {
...
class BlockFadeEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class BlockFertilizeEvent extends BlockEvent implements Cancellable {
...
class BlockFromToEvent extends BlockEvent implements Cancellable {
...
class BlockIgniteEvent extends BlockEvent implements Cancellable {
...
class BlockIgniteEvent$IgniteCause extends Enum<BlockIgniteEvent$IgniteCause> {
...
class BlockIterator extends Object implements Iterator<Block> {
...
class BlockMultiPlaceEvent extends BlockPlaceEvent {
...
class BlockPhysicsEvent extends BlockEvent implements Cancellable {
...
class BlockPopulator extends Object {
   /**Populates an area of blocks at or around the given chunk.*/
   populate (world: World, random: Random, source: Chunk): void;
}
interface BlockProjectileSource extends ProjectileSource {
...
class BlockShearEntityEvent extends BlockEvent implements Cancellable {
...
interface BlockStateMeta extends ItemMeta {
...
class BookMeta$Generation extends Enum<BookMeta$Generation> {
...
class BookMeta$Spigot extends Object {
   /**Adds new pages to the end of the book.*/
...
class BooleanPrompt extends ValidatingPrompt {
...
class BoundingBox extends Object implements Cloneable, ConfigurationSerializable {
...
class BrewEvent extends BlockEvent implements Cancellable {
...
interface BrewingStand extends BlockData {
...
class BrewingStandFuelEvent extends BlockEvent implements Cancellable {
...
class BroadcastMessageEvent extends ServerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class BroadcastPermissions extends Object {
...
interface BubbleColumn extends BlockData {
   /**Gets the value of the 'drag' property.*/
   isDrag(): boolean;
   /**Sets the value of the 'drag' property.*/
   setDrag(drag: boolean): void;
}
class BufferedCommandSender extends Object implements MessageCommandSender {
   getBuffer (): String;
   reset (): void;
...
class BukkitObjectInputStream extends ObjectInputStream {
...
class BukkitObjectOutputStream extends ObjectOutputStream {
   replaceObject (obj: Object): Object;
}
/**This class is provided as an easy way to handle scheduling tasks.*/
class BukkitRunnable extends Object implements Runnable {
...
class CachedSizeConcurrentLinkedQueue<E> extends ConcurrentLinkedQueue<E> {
   add (e: E): boolean;
   poll (): E;
   size (): number;
}
...
interface Cake extends BlockData {
...
interface Campfire extends TileState {
   /**Get cook time.*/
...
interface Campfire extends Directional, Lightable, Waterlogged {
...
/**Represents a campfire recipe.*/
class CampfireRecipe extends CookingRecipe<CampfireRecipe> {}
...
interface CartographyInventory extends Inventory {}
/**Meow.*/
interface Cat extends Tameable, Sittable {
...
class Cat$Type extends Enum<Cat$Type> {
...
class CauldronLevelChangeEvent extends BlockEvent implements Cancellable {
...
class CauldronLevelChangeEvent$ChangeReason extends Enum<CauldronLevelChangeEvent$ChangeReason> {
...
/**Represents a Spider.*/
interface CaveSpider extends Spider {}
interface Chain extends Orientable, Waterlogged {}
/**Thrown if a Plugin Channel is too long.*/
class ChannelNameTooLongException extends RuntimeException {}
/**Thrown if a Plugin attempts to send a message on an unregistered channel.*/
class ChannelNotRegisteredException extends RuntimeException {}
/**All supported color values for chat*/
class ChatColor extends Enum<ChatColor> {
...
class ChatPaginator extends Object {
...
class ChatPaginator$ChatPage extends Object {
   getLines (): String[];
   getPageNumber (): number;
   getTotalPages (): number;
}
/**Represents a captured state of a chest.*/
interface Chest extends Container, LootableBlockInventory, Lidded {
...
interface Chest extends Directional, Waterlogged {
...
class Chest$Type extends Enum<Chest$Type> {
...
class ChunkEvent extends WorldEvent {
...
class ClickType extends Enum<ClickType> {
...
class ClientOption<T> extends Object {
   getType (): Class<T>;
}
class ClientOption$ChatVisibility extends Enum<ClientOption$ChatVisibility> {
...
class CoalType extends Enum<CoalType> {
   static CHARCOAL: CoalType;
   static COAL: CoalType;
}
interface Cocoa extends Ageable, Directional {}
class CocoaPlant$CocoaPlantSize extends Enum<CocoaPlant$CocoaPlantSize> {
...
class Color extends Object implements ConfigurationSerializable {
...
interface CommandBlock extends TileState {
...
interface CommandBlock extends Directional {
...
interface CommandMinecart extends Minecart {
...
class CommandPermissions extends Object {
   static registerPermissions (parent: Permission): Permission;
}
...
class CommandSender$Spigot extends Object {
...
interface Comparator extends TileState {}
/**'mode' indicates what mode this comparator will operate in.*/
interface Comparator extends Directional, Powerable {
...
interface ComplexEntityPart extends Entity {
...
interface ComplexLivingEntity extends LivingEntity {
...
interface ComplexRecipe extends Recipe, Keyed {}
/**Represents a captured state of a conduit.*/
interface Conduit extends TileState {}
/**Represents a source of configurable options and settings*/
interface Configuration extends ConfigurationSection {
...
class ConfigurationSerialization extends Object {
...
class Conversation$ConversationState extends Enum<Conversation$ConversationState> {
...
class ConversationAbandonedEvent extends EventObject {
...
interface ConversationCanceller extends Cloneable {
...
class ConversationContext extends Object {
...
class ConversationFactory extends Object {
...
class CookingRecipe<T extends CookingRecipe> extends Object implements Recipe, Keyed {
...
interface CoralWallFan extends Directional, Waterlogged {}
class Counter<T> extends ForwardingMap<T, Long> {
...
interface CraftingInventory extends Inventory {
...
class CraftItemEvent extends InventoryClickEvent {
   /**Gets the primary Inventory involved in this transaction*/
...
interface CreatureSpawner extends TileState {
...
class CreatureSpawnEvent extends EntitySpawnEvent {
   /**Returns the Entity involved in this event*/
...
class CreatureSpawnEvent$SpawnReason extends Enum<CreatureSpawnEvent$SpawnReason> {
...
class CreeperIgniteEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Creeper;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class CreeperPowerEvent$PowerCause extends Enum<CreeperPowerEvent$PowerCause> {
...
class Criterias extends Object {}
/**Represents the different growth states of crops*/
class CropState extends Enum<CropState> {
...
interface CrossbowMeta extends ItemMeta {
...
interface DaylightDetector extends AnaloguePowerable {
...
interface DaylightDetector extends TileState {}
class DefaultPermissions extends Object {
...
class Difficulty extends Enum<Difficulty> {
...
interface Dispenser extends Directional {
...
interface Dispenser extends Container, Nameable, LootableBlockInventory {
...
/**The hinge of a door.*/
class Door$Hinge extends Enum<Door$Hinge> {
   static LEFT: Door$Hinge;
   static RIGHT: Door$Hinge;
}
/**Represents a double chest.*/
class DoubleChest extends Object implements InventoryHolder {
   /**Get the object's inventory.*/
   getInventory (): Inventory;
...
interface DoubleChestInventory extends Inventory {
   /**Gets the block or entity belonging to the open inventory*/
...
class DragonBattle$RespawnPhase extends Enum<DragonBattle$RespawnPhase> {
...
class Effect$Type extends Enum<Effect$Type> {
   static SOUND: Effect$Type;
   static VISUAL: Effect$Type;
}
/**Represents a thrown egg.*/
interface Egg extends ThrowableProjectile {}
...
interface EnchantingInventory extends Inventory {
...
interface EnchantingTable extends TileState, Nameable {}
/**Called when an ItemStack is successfully enchanted (currently at  enchantment table)*/
class EnchantItemEvent extends InventoryEvent implements Cancellable {
...
class Enchantment extends Object implements Keyed {
...
class EnchantmentOffer extends Object {
   /**Gets the cost (minimum level) which is displayed as a number on the right  hand side of the enchantment offer.*/
   getCost (): number;
...
interface EnchantmentStorageMeta extends ItemMeta {
...
class EnchantmentTarget extends Enum<EnchantmentTarget> {
...
class EnchantmentWrapper extends Enchantment {
   /**Checks if this Enchantment may be applied to the given ItemStack.*/
   canEnchantItem (item: ItemStack): boolean;
   /**Check if this enchantment conflicts with another enchantment.*/
   conflictsWith (other: Enchantment): boolean;
...
interface EnderChest extends Directional, Waterlogged {}
/**Represents a captured state of an ender chest.*/
interface EnderChest extends TileState {}
/**A crystal that heals nearby EnderDragons*/
interface EnderCrystal extends Entity {
...
interface EnderDragon extends ComplexLivingEntity, Boss, Mob {
...
class EnderDragon$Phase extends Enum<EnderDragon$Phase> {
...
class EnderDragonChangePhaseEvent extends EntityEvent implements Cancellable {
...
class EnderDragonFireballHitEvent extends EntityEvent implements Cancellable {
...
class EnderDragonFlameEvent extends EntityEvent implements Cancellable {
   getAreaEffectCloud (): AreaEffectCloud;
...
interface EnderDragonPart extends ComplexEntityPart, Damageable {
   /**Gets the parent ComplexLivingEntity of this part.*/
   getParent(): EnderDragon;
}
/**Fired when an EnderDragon shoots a fireball*/
class EnderDragonShootFireballEvent extends EntityEvent implements Cancellable {
...
interface Enderman extends Monster {
...
class EndermanAttackPlayerEvent extends EntityEvent implements Cancellable {
...
class EndermanEscapeEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Enderman;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EndermanEscapeEvent$Reason extends Enum<EndermanEscapeEvent$Reason> {
...
interface Endermite extends Monster {
...
interface EnderPearl extends ThrowableProjectile {}
/**Represents an EnderSignal, which is created upon throwing an ender eye.*/
interface EnderSignal extends Entity {
...
interface EndGateway extends TileState {
...
interface EndPortalFrame extends Directional {
...
interface Entity extends Metadatable, CommandSender, Nameable, PersistentDataHolder {
...
class Entity$Spigot extends CommandSender$Spigot {}
...
class EntityAddToWorldEvent extends EntityEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
}
/**Called when the amount of air an entity has remaining changes.*/
class EntityAirChangeEvent extends EntityEvent implements Cancellable {
...
class EntityBlockFormEvent extends BlockFormEvent {
   /**Get the entity that formed the block.*/
   getEntity (): Entity;
}
/**Represents a captured state of a block which stores entities.*/
interface EntityBlockStorage<T extends Entity> extends TileState {
...
class EntityBreakDoorEvent extends EntityChangeBlockEvent {
   /**Returns the Entity involved in this event*/
   getEntity (): LivingEntity;
}
/**Called when one Entity breeds with another Entity.*/
class EntityBreedEvent extends EntityEvent implements Cancellable {
...
class EntityChangeBlockEvent extends EntityEvent implements Cancellable {
...
class EntityDamageEvent$DamageCause extends Enum<EntityDamageEvent$DamageCause> {
...
class EntityDropItemEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityEffect extends Enum<EntityEffect> {
...
class EntityEnterBlockEvent extends EntityEvent implements Cancellable {
...
class EntityEnterLoveModeEvent extends EntityEvent implements Cancellable {
...
class EntityJumpEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): LivingEntity;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityKnockbackByEntityEvent extends EntityEvent implements Cancellable {
...
class EntityPathfindEvent extends EntityEvent implements Cancellable {
...
class EntityPortalEnterEvent extends EntityEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityPortalEvent extends EntityTeleportEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityPortalExitEvent extends EntityTeleportEvent {
...
class EntityPoseChangeEvent extends EntityEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityPotionEffectEvent extends EntityEvent implements Cancellable {
...
class EntityPotionEffectEvent$Action extends Enum<EntityPotionEffectEvent$Action> {
...
class EntityPotionEffectEvent$Cause extends Enum<EntityPotionEffectEvent$Cause> {
...
class EntityRegainHealthEvent$RegainReason extends Enum<EntityRegainHealthEvent$RegainReason> {
...
class EntityRemoveFromWorldEvent extends EntityEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
}
...
class EntitySpawnEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntitySpellCastEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
...
class EntityTameEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): LivingEntity;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityTargetEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityTargetEvent$TargetReason extends Enum<EntityTargetEvent$TargetReason> {
...
class EntityTargetLivingEntityEvent extends EntityTargetEvent {
   /**Get the entity that this is targeting.*/
...
class EntityTeleportEndGatewayEvent extends EntityTeleportEvent {
...
class EntityToggleGlideEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Gets the cancellation state of this event.*/
   isCancelled (): boolean;
...
class EntityToggleSwimEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Gets the cancellation state of this event.*/
   isCancelled (): boolean;
...
class EntityTransformedEvent$TransformedReason extends Enum<EntityTransformedEvent$TransformedReason> {
...
class EntityTransformEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class EntityTransformEvent$TransformReason extends Enum<EntityTransformEvent$TransformReason> {
...
class EntityType extends Enum<EntityType> implements Keyed {
...
class EntityUnleashEvent extends EntityEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Returns the reason for the unleashing.*/
   getReason (): EntityUnleashEvent$UnleashReason;
}
class EntityUnleashEvent$UnleashReason extends Enum<EntityUnleashEvent$UnleashReason> {
...
class EntityZapEvent extends EntityTransformEvent implements Cancellable {
...
class EquipmentSlot extends Enum<EquipmentSlot> {
...
class EulerAngle extends Object {
...
class Event$Result extends Enum<Event$Result> {
...
class EventPriority extends Enum<EventPriority> {
...
interface Evoker extends Spellcaster {}
/**Represents Evoker Fangs.*/
interface EvokerFangs extends Entity {
...
class ExactMatchConversationCanceller extends Object implements ConversationCanceller {
   /**Cancels a conversation based on user input.*/
   cancelBasedOnInput (context: ConversationContext, input: String): boolean;
   /**Allows the ConversationFactory to duplicate this  ConversationCanceller when creating a new Conversation.*/
   clone (): ConversationCanceller;
...
class ExpBottleEvent extends ProjectileHitEvent {
   /**Returns the Entity involved in this event*/
...
interface ExperienceOrb extends Entity {
...
class ExperienceOrb$SpawnReason extends Enum<ExperienceOrb$SpawnReason> {
...
class ExperienceOrbMergeEvent extends EntityEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface Explosive extends Entity {
...
interface ExplosiveMinecart extends Minecart {}
...
class FaceAttachable$AttachedFace extends Enum<FaceAttachable$AttachedFace> {
...
interface Farmland extends BlockData {
...
interface Fence extends MultipleFacing, Waterlogged {}
/**This is a base class for all File based implementations of Configuration*/
class FileConfiguration extends MemoryConfiguration {
...
class FillProfileEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   getPlayerProfile (): PlayerProfile;
...
/**md_5's mixtape.*/
interface Fire extends Ageable, MultipleFacing {}
/**Represents a Fireball.*/
interface Fireball extends Projectile, Explosive {
   /**Retrieve the direction this fireball is heading toward*/
   getDirection(): Vector;
   /**Fireballs fly straight and do not take setVelocity(...) well.*/
   setDirection(direction: Vector): void;
}
interface Firework extends Projectile {
...
class FireworkEffect extends Object implements ConfigurationSerializable {
...
class FireworkEffect$Builder extends Object {
...
class FireworkEffect$Type extends Enum<FireworkEffect$Type> {
...
interface FireworkEffectMeta extends ItemMeta {
...
class FireworkExplodeEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Firework;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface FireworkMeta extends ItemMeta {
...
interface Fish extends WaterMob {}
/**Represents a fishing hook.*/
interface FishHook extends Projectile {}
...
class FixedMetadataValue extends LazyMetadataValue {
...
class FixedSetPrompt extends ValidatingPrompt {
...
class FluidCollisionMode extends Enum<FluidCollisionMode> {
...
class FluidLevelChangeEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface Flying extends Mob {}
/**Called when a human entity's food level changes*/
class FoodLevelChangeEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
...
interface Fox extends Animals, Sittable {
...
class Fox$Type extends Enum<Fox$Type> {
   static RED: Fox$Type;
   static SNOW: Fox$Type;
}
class FullServerTickHandler extends Object {
   abort (): void;
...
interface Furnace extends Directional, Lightable {}
/**Represents a captured state of a furnace.*/
interface Furnace extends Container {
   /**Get burn time.*/
   getBurnTime(): number;
...
class FurnaceExtractEvent extends BlockExpEvent {
...
interface FurnaceInventory extends Inventory {
...
class FurnaceRecipe extends CookingRecipe<FurnaceRecipe> {
   /**Sets the input of this cooking recipe.*/
...
class GameMode extends Enum<GameMode> {
...
class GameRule<T> extends Object {
   equals (obj: Object): boolean;
...
interface Gate extends Directional, Openable, Powerable {
...
class GenericCommandHelpTopic extends HelpTopic {
   /**Determines if a Player is allowed to see this help topic.*/
   canSee (sender: CommandSender): boolean;
}
/**Represents a Ghast.*/
interface Ghast extends Flying {}
/**Represents a Giant.*/
interface Giant extends Monster {}
interface GlassPane extends MultipleFacing, Waterlogged {}
...
class GoalKey<T extends Mob> extends Object {
   equals (o: Object): boolean;
...
class GoalType extends Enum<GoalType> {
...
interface Golem extends Creature {}
/**Represents the different types of grass.*/
class GrassSpecies extends Enum<GrassSpecies> {
   static DEAD: GrassSpecies;
   static FERN_LIKE: GrassSpecies;
   static NORMAL: GrassSpecies;
}
interface Grindstone extends Directional, FaceAttachable {}
/**Interface to the inventory of a Grindstone.*/
interface GrindstoneInventory extends Inventory {
...
class GS4QueryEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Get querier address*/
...
class GS4QueryEvent$QueryResponse extends Object {
...
class GS4QueryEvent$QueryResponse$Builder extends Object {
...
/**Plugin information*/
class GS4QueryEvent$QueryResponse$PluginInformation extends Object {
   getName (): String;
   getVersion (): String;
...
/**The type of query*/
class GS4QueryEvent$QueryType extends Enum<GS4QueryEvent$QueryType> {
   static BASIC: GS4QueryEvent$QueryType;
   static FULL: GS4QueryEvent$QueryType;
}
interface Guardian extends Monster {}
/**A list of event handlers, stored per-event. Based on lahwran's fevents.*/
class HandlerList extends Object {
...
interface Hanging extends Entity, Attachable {
...
class HangingBreakByEntityEvent extends HangingBreakEvent {
   /**Gets the entity that removed the hanging entity.*/
   getRemover (): Entity;
}
/**Triggered when a hanging entity is removed*/
class HangingBreakEvent extends HangingEvent implements Cancellable {
...
class HangingBreakEvent$RemoveCause extends Enum<HangingBreakEvent$RemoveCause> {
...
class HangingEvent extends Event {
   /**Gets the hanging entity involved in this event.*/
   getEntity (): Hanging;
}
/**Triggered when a hanging entity is created in the world*/
class HangingPlaceEvent extends HangingEvent implements Cancellable {
...
class HeightMap extends Enum<HeightMap> {
...
class HelpCommand extends BukkitCommand {
...
class HelpTopic extends Object {
...
class HelpTopicComparator extends Object implements Comparator<HelpTopic> {
...
class HelpTopicComparator$TopicNameComparator extends Object implements Comparator<String> {
...
/**Represents a Hoglin.*/
interface Hoglin extends Animals {
...
interface Hopper extends Directional {
...
interface Hopper extends Container, LootableBlockInventory {}
/**Represents a Minecart with a Hopper inside it*/
interface HopperMinecart extends Minecart, InventoryHolder, LootableEntityInventory {
...
/**Represents a Horse.*/
interface Horse extends AbstractHorse {
...
class Horse$Color extends Enum<Horse$Color> {
...
class Horse$Style extends Enum<Horse$Style> {
...
interface HorseInventory extends AbstractHorseInventory, ArmoredHorseInventory {}
/**Called when a horse jumps.*/
class HorseJumpEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
...
interface HumanEntity extends LivingEntity, AnimalTamer, InventoryHolder {
...
interface Illager extends Raider {}
class IllegalPacketEvent extends PlayerEvent {
...
class IllegalPluginAccessException extends RuntimeException {}
/**Represents an Illusioner "Illager".*/
interface Illusioner extends Spellcaster, RangedEntity {}
/**An InactivityConversationCanceller will cancel a Conversation after  a period of inactivity by the user.*/
class InactivityConversationCanceller extends Object implements ConversationCanceller {
   /**Cancels a conversation based on user input.*/
   cancelBasedOnInput (context: ConversationContext, input: String): boolean;
...
class IndexHelpTopic extends HelpTopic {
   /**Allows the server administrator to override the permission required to  see a help topic.*/
   amendCanSee (amendedPermission: String): void;
...
class Instrument extends Enum<Instrument> {
...
class InventoryAction extends Enum<InventoryAction> {
...
class InventoryClickEvent extends InventoryInteractEvent {
...
class InventoryCloseEvent$Reason extends Enum<InventoryCloseEvent$Reason> {
...
class InventoryCreativeEvent extends InventoryClickEvent {
   /**Gets the current ItemStack on the cursor.*/
   getCursor (): ItemStack;
...
class InventoryDragEvent extends InventoryInteractEvent {
...
class InventoryInteractEvent extends InventoryEvent implements Cancellable {
...
class InventoryType extends Enum<InventoryType> {
...
class InventoryType$SlotType extends Enum<InventoryType$SlotType> {
...
class InventoryView$Property extends Enum<InventoryView$Property> {
...
interface IronGolem extends Golem {
...
class ItemFlag extends Enum<ItemFlag> {
...
interface ItemFrame extends Hanging {
...
class ItemSpawnEvent extends EntitySpawnEvent {
   /**Returns the Entity involved in this event*/
   getEntity (): Item;
}
...
class ItemStack extends Object implements Cloneable, ConfigurationSerializable {
...
class ItemTagType$PrimitiveTagType<T> extends Object implements ItemTagType<T, T> {
...
class JavaPluginLoader extends Object implements PluginLoader {
...
interface Jigsaw extends BlockData {
...
interface Jigsaw extends TileState {}
/**The directions the Jigsaw can be oriented.*/
class Jigsaw$Orientation extends Enum<Jigsaw$Orientation> {
...
interface KnowledgeBookMeta extends ItemMeta {
...
interface Ladder extends Directional, Waterlogged {}
/**'hanging' denotes whether the lantern is hanging from a block.*/
interface Lantern extends Waterlogged {
...
interface LargeFireball extends SizedFireball {}
...
class LazyMetadataValue extends MetadataValueAdapter {
   /**Invalidates this metadata item, forcing it to recompute when next  accessed.*/
   invalidate (): void;
   /**Fetches the value of this metadata item.*/
   value (): Object;
...
class LazyMetadataValue$CacheStrategy extends Enum<LazyMetadataValue$CacheStrategy> {
...
interface LeashHitch extends Hanging {}
...
interface LeatherArmorMeta extends ItemMeta {
...
interface Leaves extends BlockData {
...
interface Lectern extends Directional, Powerable {
   /**Gets the value of the 'has_book' property.*/
   hasBook(): boolean;
}
/**Represents a captured state of a lectern.*/
interface Lectern extends TileState, BlockInventoryHolder {
   /**Get the object's inventory.*/
   getInventory(): Inventory;
...
interface LecternInventory extends Inventory {
...
interface Levelled extends BlockData {
...
class LightningStrike$Spigot extends Entity$Spigot {
   isSilent (): boolean;
}
...
class LightningStrikeEvent$Cause extends Enum<LightningStrikeEvent$Cause> {
...
class LingeringPotionSplashEvent extends ProjectileHitEvent implements Cancellable {
...
/**Represents a Llama.*/
interface Llama extends ChestedHorse, RangedEntity {
...
class Llama$Color extends Enum<Llama$Color> {
...
interface LlamaInventory extends SaddledHorseInventory {
...
interface LlamaSpit extends Projectile {}
...
class LoadingIntMap<V> extends it$unimi$dsi$fastutil$ints$Int2ObjectOpenHashMap<V> {
   get (key: number): V;
}
/**Due to java stuff, you will need to cast it to (Function) for some cases*/
class LoadingIntMap$Feeder<T> extends Object implements Function<T, T> {
   apply (): T;
...
class LoadingMap<K, V> extends AbstractMap<K, V> {
   clear (): void;
...
/**Due to java stuff, you will need to cast it to (Function) for some cases*/
class LoadingMap$Feeder<T> extends Object implements Function<T, T> {
   apply (): T;
   apply (input: Object): T;
}
...
class Location extends Object implements Cloneable, ConfigurationSerializable {
...
class LookupProfileEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   getPlayerProfile (): PlayerProfile;
}
/**Interface to the inventory of a Loom.*/
interface LoomInventory extends Inventory {}
...
interface LootableBlockInventory extends LootableInventory {
   /**Gets the block that is lootable*/
   getBlock(): Block;
}
/**Represents an Inventory that can generate loot, such as Minecarts inside of Mineshafts*/
interface LootableEntityInventory extends LootableInventory {
...
interface LootableInventory extends Lootable {
...
class LootableInventoryReplenishEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class LootContext extends Object {
...
class LootContext$Builder extends Object {
...
class LootGenerateEvent extends WorldEvent implements Cancellable {
...
class LootTables extends Enum<LootTables> implements Keyed {
...
class MainHand extends Enum<MainHand> {
...
class ManuallyAbandonedConversationCanceller extends Object implements ConversationCanceller {
   /**Cancels a conversation based on user input.*/
   cancelBasedOnInput (context: ConversationContext, input: String): boolean;
   /**Allows the ConversationFactory to duplicate this  ConversationCanceller when creating a new Conversation.*/
   clone (): ConversationCanceller;
...
class MapCursor extends Object {
...
class MapCursor$Type extends Enum<MapCursor$Type> {
...
class MapCursorCollection extends Object {
...
class MapFont$CharacterSprite extends Object {
...
class MapInitializeEvent extends ServerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface MapMeta extends ItemMeta {
   clone(): MapMeta;
...
class MapPalette extends Object {
   /**Resize an image to 128x128.*/
   static resizeImage (image: Image): BufferedImage;
}
/**Represents a renderer for a map.*/
class MapRenderer extends Object {
...
class MapView$Scale extends Enum<MapView$Scale> {
...
class Material extends Enum<Material> implements Keyed {
...
class MaterialSetTag extends Object implements Tag<Material> {
...
class MaterialTags extends Object {}
...
class MemoryConfiguration extends MemorySection implements Configuration {
   /**Sets the default value in the root at the given path as provided.*/
   addDefault (path: String, value: Object): void;
   /**Sets the default values of the given paths as provided.*/
   addDefaults (defaults: Map<String, Object>): void;
...
class MemoryConfigurationOptions extends ConfigurationOptions {
   /**Returns the Configuration that this object is responsible for.*/
...
class MemoryKey<T> extends Object implements Keyed {
...
class MemorySection extends Object implements ConfigurationSection {
   /**Sets the default value in the root at the given path as provided.*/
   addDefault (path: String, value: Object): void;
   /**Checks if this ConfigurationSection contains the given path.*/
   contains (path: String): boolean;
...
interface MerchantInventory extends Inventory {
...
class MerchantRecipe extends Object implements Recipe {
...
interface MessageCommandSender extends CommandSender {
...
class MessagePrompt extends Object implements Prompt {
...
class MetadataConversionException extends RuntimeException {}
...
class MetadataStoreBase<T> extends Object {
...
class MetadataValueAdapter extends Object implements MetadataValue {
   /**Attempts to convert the value of this metadata item into a boolean.*/
   asBoolean (): boolean;
   /**Attempts to convert the value of this metadata item into a byte.*/
   asByte (): number;
...
class MethodHandleEventExecutor extends Object implements EventExecutor {
   execute (listener: Listener, event: Event): void;
}
/**Represents a minecart entity.*/
interface Minecart extends Vehicle {
...
class Mirror extends Enum<Mirror> {
...
class MoistureChangeEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class MRUMapCache<K, V> extends AbstractMap<K, V> {
   clear (): void;
   containsKey (key: Object): boolean;
   containsValue (value: Object): boolean;
   entrySet (): Set<Map$Entry<K, V>>;
...
interface Mule extends ChestedHorse {}
/**Represents a command that delegates to one or more other commands*/
class MultipleCommandAlias extends Command {
   /**Executes the command, returning its success*/
   execute (sender: CommandSender, commandLabel: String, args: String[]): boolean;
...
interface MultipleFacing extends BlockData {
...
class MushroomBlockTexture extends Enum<MushroomBlockTexture> {
...
interface MushroomCow extends Cow {
...
class MushroomCow$Variant extends Enum<MushroomCow$Variant> {
...
class NamespacedKey extends Object implements Namespaced {
   equals (obj: Object): boolean;
   /**Gets the key corresponding to this resource*/
   getKey (): String;
   /**Gets the namespace this resource is a part of*/
...
class NamespacedTag extends Object implements Namespaced {
   equals (obj: Object): boolean;
   /**Gets the key corresponding to this resource*/
   getKey (): String;
   /**Gets the namespace this resource is a part of*/
...
class NetherWartsState extends Enum<NetherWartsState> {
...
class NoiseGenerator extends Object {
...
class Note$Tone extends Enum<Note$Tone> {
   static A: Note$Tone;
   static B: Note$Tone;
   static C: Note$Tone;
   static D: Note$Tone;
...
interface NoteBlock extends Powerable {
...
class NotePlayEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class NullConversationPrefix extends Object implements ConversationPrefix {
   /**Prepends each conversation message with an empty string.*/
   getPrefix (context: ConversationContext): String;
}
class NullTimingHandler extends Object implements Timing {
   abort (): void;
   close (): void;
   /**Used internally to get the actual backing Handler in the case of delegated Handlers*/
   getTimingHandler (): co$aikar$timings$TimingHandler;
...
class NumberConversions extends Object {
...
class NumericPrompt extends ValidatingPrompt {
...
interface Observer extends Directional, Powerable {}
/**A wild tameable cat*/
interface Ocelot extends Animals {
   /**Gets the current type of this cat.*/
...
class OctaveGenerator extends Object {
...
interface OfflinePlayer extends ServerOperator, AnimalTamer, ConfigurationSerializable {
...
interface Orientable extends BlockData {
...
interface Painting extends Hanging {
...
/**Panda entity.*/
interface Panda extends Animals {
...
class Panda$Gene extends Enum<Panda$Gene> {
...
class PaperPluginLogger extends Logger {
...
class PaperServerListPingEvent extends ServerListPingEvent implements Cancellable {
...
/**Represents a Parrot.*/
interface Parrot extends Tameable, Sittable {
...
class Parrot$Variant extends Enum<Parrot$Variant> {
...
class Particle extends Enum<Particle> {
   static ASH: Particle;
...
class Particle$DustOptions extends Object {
...
class ParticleBuilder extends Object {
...
class Pattern extends Object implements ConfigurationSerializable {
   equals (obj: Object): boolean;
...
class PatternType extends Enum<PatternType> {
...
class PerlinNoiseGenerator extends NoiseGenerator {
...
class PermissibleBase extends Object implements Permissible {
   /**Adds a new empty PermissionAttachment to this object*/
   addAttachment (plugin: Plugin): PermissionAttachment;
   /**Temporarily adds a new empty PermissionAttachment to this  object*/
   addAttachment (plugin: Plugin, ticks: number): PermissionAttachment;
...
class PermissionAttachment extends Object {
...
class PermissionAttachmentInfo extends Object {
...
class PermissionDefault extends Enum<PermissionDefault> {
...
/**A default implementation that simply exists to pass on the retrieved or  inserted value to the next layer.    This implementation does not add any kind of logic, but is used to  provide default implementations for the primitive types.*/
class PersistentDataType$PrimitivePersistentDataType<T> extends Object implements PersistentDataType<T, T> {
   /**Creates a complex object based of the passed primitive value*/
...
interface Phantom extends Flying {
   getSize(): number;
...
class PhantomPreSpawnEvent extends PreCreatureSpawnEvent {
   /**Get the entity this phantom is spawning for*/
   getSpawningEntity (): Entity;
}
/**Represents a Pig.*/
interface Pig extends Steerable, Vehicle {}
/**Represents a Piglin.*/
interface Piglin extends PiglinAbstract {
...
/**Piglin / Piglin Brute.*/
interface PiglinAbstract extends Monster, Ageable {
...
interface PiglinBrute extends PiglinAbstract {}
/**Stores data for pigs being zapped*/
class PigZapEvent extends EntityZapEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Pig;
...
interface PigZombie extends Zombie {
...
class PigZombieAngerEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): PigZombie;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
/**Illager entity.*/
interface Pillager extends Illager, InventoryHolder {}
/**'extended' denotes whether the piston head is currently extended or not.*/
interface Piston extends Directional {
...
interface PistonHead extends TechnicalPiston {
...
class PistonMoveReaction extends Enum<PistonMoveReaction> {
...
interface Player extends HumanEntity, Conversable, OfflinePlayer, PluginMessageRecipient, NetworkClient {
...
class Player$Spigot extends Entity$Spigot {
...
class PlayerAdvancementCriterionGrantEvent extends PlayerEvent implements Cancellable {
...
class PlayerAdvancementDoneEvent extends PlayerEvent {
...
class PlayerAnimationType extends Enum<PlayerAnimationType> {
...
class PlayerArmorChangeEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerArmorChangeEvent$SlotType extends Enum<PlayerArmorChangeEvent$SlotType> {
...
class PlayerArmorStandManipulateEvent extends PlayerInteractEntityEvent {
...
class PlayerAttackEntityCooldownResetEvent extends PlayerEvent implements Cancellable {
...
class PlayerAttemptPickupItemEvent extends PlayerEvent implements Cancellable {
...
class PlayerBedEnterEvent$BedEnterResult extends Enum<PlayerBedEnterEvent$BedEnterResult> {
...
class PlayerBucketEvent extends PlayerEvent implements Cancellable {
   /**Gets the block involved in this event.*/
   getBlock (): Block;
...
class PlayerChangedMainHandEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerChangedWorldEvent extends PlayerEvent {
...
class PlayerChannelEvent extends PlayerEvent {
   getChannel (): String;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
}
/**Called when the player changes his client settings*/
class PlayerClientOptionsChangeEvent extends PlayerEvent {
...
class PlayerCommandSendEvent extends PlayerEvent {
...
class PlayerConnectionCloseEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerEggThrowEvent extends PlayerEvent {
...
class PlayerElytraBoostEvent extends PlayerEvent implements Cancellable {
...
class PlayerExpChangeEvent extends PlayerEvent {
...
class PlayerFishEvent$State extends Enum<PlayerFishEvent$State> {
...
class PlayerHandshakeEvent extends Event implements Cancellable {
...
class PlayerHarvestBlockEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerInteractAtEntityEvent extends PlayerInteractEntityEvent {
...
class PlayerItemBreakEvent extends PlayerEvent {
...
class PlayerItemDamageEvent extends PlayerEvent implements Cancellable {
...
class PlayerItemMendEvent extends PlayerEvent implements Cancellable {
...
class PlayerJumpEvent extends PlayerEvent implements Cancellable {
...
class PlayerLaunchProjectileEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerLeashEntityEvent extends Event implements Cancellable {
...
class PlayerLevelChangeEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerLocaleChangeEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   getLocale (): String;
}
...
/**Basic kick reasons for communicating to plugins*/
class PlayerLoginEvent$Result extends Enum<PlayerLoginEvent$Result> {
...
class PlayerNamePrompt extends ValidatingPrompt {
   /**Override this method to accept and processes the validated input from  the user.*/
   acceptValidatedInput (context: ConversationContext, input: String): Prompt;
...
class PlayerNaturallySpawnCreaturesEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerPickupArrowEvent extends PlayerPickupItemEvent {
   /**Get the arrow being picked up by the player*/
   getArrow (): AbstractArrow;
}
/**Fired when a player is attempting to pick up an experience orb*/
class PlayerPickupExperienceEvent extends PlayerEvent implements Cancellable {
   getExperienceOrb (): ExperienceOrb;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Gets the cancellation state of this event.*/
...
class PlayerPortalEvent extends PlayerTeleportEvent {
...
class PlayerPostRespawnEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
/**Basic kick reasons for communicating to plugins*/
class PlayerPreLoginEvent$Result extends Enum<PlayerPreLoginEvent$Result> {
...
class PlayerReadyArrowEvent extends PlayerEvent implements Cancellable {
   getArrow (): ItemStack;
   getBow (): ItemStack;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerRecipeBookClickEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerRecipeDiscoverEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerRegisterChannelEvent extends PlayerChannelEvent {}
/**Called when a player takes action on a resource pack request sent via  Player.setResourcePack(java.lang.String).*/
class PlayerResourcePackStatusEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerResourcePackStatusEvent$Status extends Enum<PlayerResourcePackStatusEvent$Status> {
...
class PlayerRiptideEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerShearEntityEvent extends PlayerEvent implements Cancellable {
...
class PlayerSpawnLocationEvent extends PlayerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerStartSpectatingEntityEvent extends PlayerEvent implements Cancellable {
...
class PlayerStatisticIncrementEvent extends PlayerEvent implements Cancellable {
...
class PlayerStopSpectatingEntityEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerSwapHandItemsEvent extends PlayerEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PlayerTakeLecternBookEvent extends PlayerEvent implements Cancellable {
...
class PlayerTeleportEndGatewayEvent extends PlayerTeleportEvent {
   /**The gateway triggering the teleport*/
   getGateway (): EndGateway;
}
/**Holds information for player teleport events*/
class PlayerTeleportEvent extends PlayerMoveEvent {
   /**Gets the cause of this teleportation event*/
   getCause (): PlayerTeleportEvent$TeleportCause;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
}
class PlayerTeleportEvent$TeleportCause extends Enum<PlayerTeleportEvent$TeleportCause> {
...
class PlayerUnleashEntityEvent extends EntityUnleashEvent implements Cancellable {
...
class PlayerUnregisterChannelEvent extends PlayerChannelEvent {}
class PlayerUseUnknownEntityEvent extends PlayerEvent {
   getEntityId (): number;
   getHand (): EquipmentSlot;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PluginAwareness$Flags extends Enum<PluginAwareness$Flags> implements PluginAwareness {
   static UTF8: PluginAwareness$Flags;
}
/**Represents a base Plugin    Extend this class if your plugin is not a JavaPlugin*/
class PluginBase extends Object implements Plugin {
   equals (obj: Object): boolean;
   /**Returns the name of the plugin.*/
   getName (): String;
   hashCode (): number;
...
class PluginChannelDirection extends Enum<PluginChannelDirection> {
...
class PluginCommandYamlParser extends Object {
...
class PluginDescriptionFile extends Object {
...
class PluginEvent extends ServerEvent {
...
class PluginLoadOrder extends Enum<PluginLoadOrder> {
...
class PluginMessageListenerRegistration extends Object {
   equals (obj: Object): boolean;
...
class PluginNameConversationPrefix extends Object implements ConversationPrefix {
   /**Prepends each conversation message with the plugin name.*/
   getPrefix (context: ConversationContext): String;
}
class PluginsCommand extends BukkitCommand {
   /**Executes the command, returning its success*/
   execute (sender: CommandSender, currentAlias: String, args: String[]): boolean;
   /**Executed on tab completion for this command, returning a list of  options the player can tab through.*/
   tabComplete (sender: CommandSender, alias: String, args: String[]): List<String>;
...
interface PolarBear extends Animals {}
/**Called when a portal is created*/
class PortalCreateEvent extends WorldEvent implements Cancellable {
...
class PortalCreateEvent$CreateReason extends Enum<PortalCreateEvent$CreateReason> {
...
class PotionData extends Object {
   equals (obj: Object): boolean;
...
class PotionEffect extends Object implements ConfigurationSerializable {
...
class PotionEffectType extends Object {
...
/**Called when a splash potion hits an area*/
class PotionSplashEvent extends ProjectileHitEvent implements Cancellable {
...
class PotionType extends Enum<PotionType> {
...
interface PoweredMinecart extends Minecart {}
...
class PreCreatureSpawnEvent extends Event implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class PreFillProfileEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   getPlayerProfile (): PlayerProfile;
...
class PreLookupProfileEvent extends Event {
...
class PrepareAnvilEvent extends PrepareResultEvent {
   /**Gets the primary Inventory involved in this transaction*/
   getInventory (): AnvilInventory;
...
class PrepareItemCraftEvent extends InventoryEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Gets the primary Inventory involved in this transaction*/
   getInventory (): CraftingInventory;
...
class PrepareItemEnchantEvent extends InventoryEvent implements Cancellable {
   /**Gets the block being used to enchant the item*/
   getEnchantBlock (): Block;
   /**Gets the player enchanting the item*/
   getEnchanter (): Player;
...
class PrepareResultEvent extends InventoryEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Get result item, may be null.*/
   getResult (): ItemStack;
...
class PrepareSmithingEvent extends PrepareResultEvent {
   /**Gets the primary Inventory involved in this transaction*/
...
class PreSpawnerSpawnEvent extends PreCreatureSpawnEvent {
...
class ProfileProperty extends Object {
   equals (o: Object): boolean;
   getName (): String;
   getSignature (): String;
   getValue (): String;
...
class ProfileWhitelistVerifyEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   getKickMessage (): String;
   getPlayerProfile (): PlayerProfile;
...
class ProjectileCollideEvent extends EntityEvent implements Cancellable {
...
class ProjectileLaunchEvent extends EntitySpawnEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Projectile;
   /**Gets the cancellation state of this event.*/
   isCancelled (): boolean;
...
interface Prompt extends Cloneable {
...
interface ProxiedCommandSender extends CommandSender {
...
interface PufferFish extends Fish {
...
class RaidSpawnWaveEvent extends RaidEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class RaidStopEvent$Reason extends Enum<RaidStopEvent$Reason> {
...
class RaidTriggerEvent extends RaidEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface Rail extends BlockData {
...
class Rail$Shape extends Enum<Rail$Shape> {
...
interface RangedEntity extends Mob {
...
/**Illager beast.*/
interface Ravager extends Raider {}
...
class RayTraceResult extends Object {
   equals (obj: Object): boolean;
   /**Gets the hit block.*/
   getHitBlock (): Block;
...
interface RecipeChoice extends Predicate<ItemStack>, Cloneable {
   clone(): RecipeChoice;
   test(itemStack: ItemStack): boolean;
}
/**Represents a choice of multiple matching Materials.*/
class RecipeChoice$MaterialChoice extends Object implements RecipeChoice {
...
interface RedstoneRail extends Powerable, Rail {}
interface RedstoneWallTorch extends Directional, Lightable {}
/**'north', 'east', 'south', 'west' represent the types of connections this  redstone wire has to adjacent blocks.*/
interface RedstoneWire extends AnaloguePowerable {
   /**Gets all of this faces which may be set on this block.*/
   getAllowedFaces(): Set<BlockFace>;
...
class RedstoneWire$Connection extends Enum<RedstoneWire$Connection> {
...
class RegexPrompt extends ValidatingPrompt {
   /**Override this method to check the validity of the player's input.*/
   isInputValid (context: ConversationContext, input: String): boolean;
}
/**Stores relevant information for plugin listeners*/
class RegisteredListener extends Object {
...
class RegisteredServiceProvider<T> extends Object implements Comparable<RegisteredServiceProvider<X>> {
...
interface Registry<T extends Keyed> extends Iterable<T> {
   /**Get the object by its key.*/
   get(key: NamespacedKey): T;
}
class Registry$SimpleRegistry<T extends Enum<T> & Keyed> extends Object implements Registry<T> {
   /**Get the object by its key.*/
   get (key: NamespacedKey): T;
   iterator (): Iterator<T>;
}
class ReloadCommand extends BukkitCommand {
   /**Executes the command, returning its success*/
   execute (sender: CommandSender, currentAlias: String, args: String[]): boolean;
   /**Executed on tab completion for this command, returning a list of  options the player can tab through.*/
   tabComplete (sender: CommandSender, alias: String, args: String[]): List<String>;
...
interface Repeater extends Directional, Powerable {
...
class ReputationType extends Enum<ReputationType> {
...
class ReservedChannelException extends RuntimeException {}
/**'charges' represents the amount of times the anchor may still be used.*/
interface RespawnAnchor extends BlockData {
...
interface RideableMinecart extends Minecart {}
/**'rotation' represents the current rotation of this block.*/
interface Rotatable extends BlockData {
...
interface SaddledHorseInventory extends AbstractHorseInventory {}
class SafeClassDefiner extends Object implements ClassDefiner {
   /**Define a class*/
   defineClass (parentLoader: ClassLoader, name: String, data: number[]): Class<X>;
}
/**Represents a salmon fish.*/
interface Salmon extends Fish {}
/**Represents the three different types of Sandstone*/
class SandstoneType extends Enum<SandstoneType> {
...
interface Sapling extends BlockData {
...
interface Scaffolding extends Waterlogged {
   /**Gets the value of the 'distance' property.*/
   getDistance(): number;
...
interface SeaPickle extends Waterlogged {
...
class Server$Spigot extends Object {
   /**Sends the component to the player*/
   broadcast (component: BaseComponent): void;
   /**Sends an array of components as a single message to the player*/
   broadcast (...components: BaseComponent[]): void;
...
class ServerCommandException extends ServerException {
...
class ServerEventException extends ServerPluginException {
...
class ServerListPingEvent extends ServerEvent implements Iterable<Player> {
...
class ServerLoadEvent extends ServerEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class ServerLoadEvent$LoadType extends Enum<ServerLoadEvent$LoadType> {
...
class ServerPluginEnableDisableException extends ServerPluginException {}
/**Wrapper exception for all cases to which a plugin can be immediately blamed for*/
class ServerPluginException extends ServerException {
   /**Gets the plugin which is directly responsible for the exception being thrown*/
   getResponsiblePlugin (): Plugin;
}
/**Thrown when an incoming plugin message channel throws an exception*/
class ServerPluginMessageException extends ServerPluginException {
...
class ServerSchedulerException extends ServerPluginException {
   /**Gets the task which threw the exception*/
   getTask (): BukkitTask;
}
/**Called when a tab-complete request throws an exception*/
class ServerTabCompleteException extends ServerCommandException {}
/**Called when the server has finished ticking the main loop*/
class ServerTickEndEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class ServerTickStartEvent extends Event {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   getTickNumber (): number;
}
/**An event relating to a registered service. This is called in a ServicesManager*/
class ServiceEvent extends ServerEvent {
   getProvider (): RegisteredServiceProvider<X>;
}
/**Represents various priorities of a provider.*/
class ServicePriority extends Enum<ServicePriority> {
...
class ServiceRegisterEvent extends ServiceEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
}
...
class ServiceUnregisterEvent extends ServiceEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
}
/**Represents a shaped (ie normal) crafting recipe.*/
class ShapedRecipe extends Object implements Recipe, Keyed {
...
class ShapelessRecipe extends Object implements Recipe, Keyed {
...
/**Represents a Sheep.*/
interface Sheep extends Animals, Colorable {
   isSheared(): boolean;
   setSheared(flag: boolean): void;
}
/**Called when a sheep's wool is dyed*/
class SheepDyeWoolEvent extends EntityEvent implements Cancellable {
...
class SheepRegrowWoolEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Sheep;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface Shulker extends Golem, Colorable {}
/**Represents a captured state of a ShulkerBox.*/
interface ShulkerBox extends Container, LootableBlockInventory, Lidded {
   /**Get the DyeColor corresponding to this ShulkerBox*/
   getColor(): DyeColor;
}
interface ShulkerBullet extends Projectile {
   /**Retrieve the target of this bullet.*/
   getTarget(): Entity;
   /**Sets the target of this bullet*/
   setTarget(target: Entity): void;
}
interface Sign extends Rotatable, Waterlogged {}
/**Represents a captured state of either a SignPost or a WallSign.*/
interface Sign extends TileState, Colorable {
...
interface Silverfish extends Monster {}
class SimpleCommandMap extends Object implements CommandMap {
   /**Clears all registered commands.*/
   clearCommands (): void;
   /**Looks for the requested command and executes it if found.*/
...
/**Handles all plugin management from the Server*/
class SimplePluginManager extends Object implements PluginManager {
   /**Adds a Permission to this plugin manager.*/
   addPermission (perm: Permission): void;
   /**Calls an event with the given details.*/
   callEvent (event: Event): void;
...
class SimpleServicesManager extends Object implements ServicesManager {
   /**Get a list of known services.*/
...
class SimplexNoiseGenerator extends PerlinNoiseGenerator {
...
class SimplexOctaveGenerator extends OctaveGenerator {
...
interface SizedFireball extends Fireball {
...
interface Skull extends TileState {
...
interface SkullMeta extends ItemMeta {
   clone(): SkullMeta;
...
interface Slab extends Waterlogged {
   /**Gets the value of the 'type' property.*/
   getType(): Slab$Type;
   /**Sets the value of the 'type' property.*/
...
class SlimeChangeDirectionEvent extends SlimePathfindEvent implements Cancellable {
...
class SlimePathfindEvent extends EntityEvent implements Cancellable {
...
class SlimeSplitEvent extends EntityEvent implements Cancellable {
...
class SlimeSwimEvent extends SlimeWanderEvent implements Cancellable {}
...
class SlimeTargetLivingEntityEvent extends SlimePathfindEvent implements Cancellable {
...
class SlimeWanderEvent extends SlimePathfindEvent implements Cancellable {}
/**Represents a small Fireball*/
interface SmallFireball extends SizedFireball {}
/**Interface to the inventory of a Smithing table.*/
interface SmithingInventory extends Inventory {
...
class SmithingRecipe extends Object implements Recipe, Keyed {
...
interface Smoker extends Furnace {}
/**Represents a campfire recipe.*/
class SmokingRecipe extends CookingRecipe<SmokingRecipe> {}
class SneakyThrow extends Object {
...
interface Snow extends BlockData {
...
interface Snowable extends BlockData {
...
interface Snowball extends ThrowableProjectile {}
/**Represents a snowman entity*/
interface Snowman extends Golem, RangedEntity {
...
class Sound extends Enum<Sound> {
...
class SoundCategory extends Enum<SoundCategory> {
...
interface SpawnEggMeta extends ItemMeta {
   clone(): SpawnEggMeta;
}
/**Represents a Minecart with an entity spawner inside it.*/
interface SpawnerMinecart extends Minecart {}
...
class SpawnerSpawnEvent extends EntitySpawnEvent {
   getSpawner (): CreatureSpawner;
}
/**Represents a spectral arrow.*/
interface SpectralArrow extends AbstractArrow {
...
interface Spellcaster extends Illager {
...
class Spellcaster$Spell extends Enum<Spellcaster$Spell> {
...
/**Represents a Spider.*/
interface Spider extends Monster {}
...
class SpongeAbsorbEvent extends BlockEvent implements Cancellable {
...
/**Represents a Squid.*/
interface Squid extends WaterMob {}
/**'shape' represents the texture and bounding box shape of these stairs.*/
interface Stairs extends Bisected, Directional, Waterlogged {
   /**Gets the value of the 'shape' property.*/
...
class Stairs$Shape extends Enum<Stairs$Shape> {
...
class StandardMessenger extends Object implements Messenger {
   /**Dispatches the specified incoming message to any registered listeners.*/
   dispatchIncomingMessage (source: Player, channel: String, message: number[]): void;
   /**Gets a set containing all the incoming plugin channel registrations  that are on the requested channel.*/
   getIncomingChannelRegistrations (channel: String): Set<PluginMessageListenerRegistration>;
...
class StaticMethodHandleEventExecutor extends Object implements EventExecutor {
   execute (listener: Listener, event: Event): void;
}
/**Represents a countable statistic, which is tracked by the server.*/
class Statistic extends Enum<Statistic> implements Keyed {
...
class Statistic$Type extends Enum<Statistic$Type> {
...
interface StatusClient extends NetworkClient {
...
interface Steerable extends Animals {
...
interface StonecutterInventory extends Inventory {
   /**Gets the input item.*/
...
class StonecuttingRecipe extends Object implements Recipe, Keyed {
   /**Get the group of this recipe.*/
   getGroup (): String;
   /**Get the input material.*/
   getInput (): ItemStack;
...
interface StorageMinecart extends Minecart, InventoryHolder, LootableEntityInventory {}
/**Represents a Stray - variant of Skeleton.*/
interface Stray extends Skeleton {}
/**Represents a Strider.*/
interface Strider extends Steerable, Vehicle {
...
class StriderTemperatureChangeEvent extends EntityEvent {
   /**Returns the Entity involved in this event*/
   getEntity (): Strider;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class StringPrompt extends Object implements Prompt {
...
interface Structure extends TileState {
...
interface StructureBlock extends BlockData {
   /**Gets the value of the 'mode' property.*/
...
class StructureBlock$Mode extends Enum<StructureBlock$Mode> {
...
class StructureRotation extends Enum<StructureRotation> {
...
class StructureType extends Object {
   equals (other: Object): boolean;
...
interface SuspiciousStewMeta extends ItemMeta {
...
interface Switch extends Directional, FaceAttachable, Powerable {}
...
class TabCompleteEvent extends Event implements Cancellable {
   /**Return the entire buffer which formed the basis of this completion.*/
   getBuffer (): String;
   /**The list of completions which will be offered to the sender, in order.*/
   getCompletions (): List<String>;
...
interface Tameable extends Animals {
...
class TargetBlockInfo extends Object {
...
class TargetBlockInfo$FluidMode extends Enum<TargetBlockInfo$FluidMode> {
...
class TargetEntityInfo extends Object {
...
class Team$Option extends Enum<Team$Option> {
...
class Team$OptionStatus extends Enum<Team$OptionStatus> {
...
interface TechnicalPiston extends Directional {
   /**Gets the value of the 'type' property.*/
...
class TechnicalPiston$Type extends Enum<TechnicalPiston$Type> {
   static NORMAL: TechnicalPiston$Type;
   static STICKY: TechnicalPiston$Type;
}
interface ThrowableProjectile extends Projectile {
...
class ThrownEggHatchEvent extends Event {
   /**Gets the egg involved in this event.*/
   getEgg (): Egg;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface ThrownExpBottle extends ThrowableProjectile {}
/**Represents a thrown potion bottle*/
interface ThrownPotion extends Projectile {
...
class TimedEventExecutor extends Object implements EventExecutor {
   execute (listener: Listener, event: Event): void;
}
/**Extends RegisteredListener to include timing information*/
class TimedRegisteredListener extends RegisteredListener {
   /**Calls the event executor*/
   callEvent (event: Event): void;
...
class TimeSkipEvent extends WorldEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class TimeSkipEvent$SkipReason extends Enum<TimeSkipEvent$SkipReason> {
...
class TimingHistory extends Object {}
...
class TimingsCommand extends BukkitCommand {
   /**Executes the command, returning its success*/
   execute (sender: CommandSender, currentAlias: String, args: String[]): boolean;
   /**Executed on tab completion for this command, returning a list of  options the player can tab through.*/
   tabComplete (sender: CommandSender, alias: String, args: String[]): List<String>;
}
class TimingsManager extends Object {
...
class TimingsReportListener extends Object implements MessageCommandSender {
...
class Title$Builder extends Object {
...
interface TNT extends BlockData {
...
interface TNTPrimed extends Explosive {
...
class TNTPrimeEvent extends BlockEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class TNTPrimeEvent$PrimeReason extends Enum<TNTPrimeEvent$PrimeReason> {
...
interface TraderLlama extends Llama {}
...
class TradeSelectEvent extends InventoryInteractEvent {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface TrapDoor extends Bisected, Directional, Openable, Powerable, Waterlogged {}
/**Represents the different species of trees regardless of size.*/
class TreeSpecies extends Enum<TreeSpecies> {
...
class TreeType extends Enum<TreeType> {
...
class TropicalFish$Pattern extends Enum<TropicalFish$Pattern> {
...
interface TropicalFishBucketMeta extends ItemMeta {
...
/**Represents a turtle.*/
interface Turtle extends Animals {
...
interface TurtleEgg extends BlockData {
...
class TurtleGoHomeEvent extends EntityEvent implements Cancellable {
...
class TurtleLayEggEvent extends EntityEvent implements Cancellable {
...
class TurtleStartDiggingEvent extends EntityEvent implements Cancellable {
   /**The turtle digging*/
   getEntity (): Turtle;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class UnknownCommandEvent extends Event {
...
class ValidatingPrompt extends Object implements Prompt {
...
interface VanillaGoal<T extends Mob> extends Goal<T> {}
...
class Vector extends Object implements Cloneable, ConfigurationSerializable {
...
class VehicleCollisionEvent extends VehicleEvent {}
/**Raised when a vehicle is created.*/
class VehicleCreateEvent extends VehicleEvent implements Cancellable {
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Gets the cancellation state of this event.*/
   isCancelled (): boolean;
...
class VehicleEntityCollisionEvent extends VehicleCollisionEvent implements Cancellable {
   getEntity (): Entity;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
   /**Gets the cancellation state of this event.*/
...
class VehicleExitEvent extends VehicleEvent implements Cancellable {
...
class VersionCommand extends BukkitCommand {
   /**Executes the command, returning its success*/
   execute (sender: CommandSender, currentAlias: String, args: String[]): boolean;
   /**Executed on tab completion for this command, returning a list of  options the player can tab through.*/
   tabComplete (sender: CommandSender, alias: String, args: String[]): List<String>;
...
class VersionFetcher$DummyVersionFetcher extends Object implements VersionFetcher {
   /**Amount of time to cache results for in milliseconds*/
   getCacheTime (): number;
   /**Gets the version message to cache and show to command senders.*/
   getVersionMessage (serverVersion: String): String;
...
class Villager$Profession extends Enum<Villager$Profession> implements Keyed {
...
class Villager$Type extends Enum<Villager$Type> implements Keyed {
...
class VillagerAcquireTradeEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
...
class VillagerCareerChangeEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Villager;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class VillagerCareerChangeEvent$ChangeReason extends Enum<VillagerCareerChangeEvent$ChangeReason> {
...
class VillagerReplenishTradeEvent extends EntityEvent implements Cancellable {
...
interface Vindicator extends Illager {
...
interface Wall extends Waterlogged {
...
class Wall$Height extends Enum<Wall$Height> {
   static LOW: Wall$Height;
   static NONE: Wall$Height;
   static TALL: Wall$Height;
}
interface WallSign extends Directional, Waterlogged {}
/**Represents a wandering trader NPC*/
interface WanderingTrader extends AbstractVillager {}
/**This represents the states that server verbose for warnings may be.*/
class Warning$WarningState extends Enum<Warning$WarningState> {
...
interface WaterMob extends Creature {}
...
/**Represents a Witch*/
interface Witch extends Raider, RangedEntity {
...
class WitchConsumePotionEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Witch;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class WitchReadyPotionEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Witch;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
class WitchThrowPotionEvent extends EntityEvent implements Cancellable {
   /**Returns the Entity involved in this event*/
   getEntity (): Witch;
   static getHandlerList (): HandlerList;
   getHandlers (): HandlerList;
...
interface Wither extends Monster, Boss, RangedEntity {}
...
interface WitherSkull extends Fireball {
...
/**Represents a Wolf*/
interface Wolf extends Tameable, Sittable {
...
class WorldCreator extends Object {
...
/**Represents a Zoglin.*/
interface Zoglin extends Monster, Ageable {}
/**Represents a Zombie.*/
interface Zombie extends Monster, Ageable {
...
interface ZombieHorse extends AbstractHorse {}
